...
class MotorCtrl{
    public:
        MotorCtrl();
#if  defined(HW_N20D)
        void config(const unsigned int PIN_PWM, const unsigned int PIN_IN1, const unsigned int PIN_IN2, const unsigned int PIN_ENC1, const unsigned int PIN_ENC2, const int timerNum, MotorCtrl_Side side);
#elif defined(HW_ORIGINAL)
        void config(const unsigned int PIN_PWM, const unsigned int PIN_IN1, const unsigned int PIN_IN2, const unsigned int PIN_ENC1, const int timerNum);
#else
    #error "Must select HW configuration!"
        ...
        volatile int enc_total;

    private:
        MotorCtrl_Side side_;
